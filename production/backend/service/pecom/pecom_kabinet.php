...
class PecomKabinet
{
	 ...
	 * @var string
	 */
	private $_api_login = 'cargoguru';
	
	/**
	 * Ключ доступа к API
	 * @var string
	 */
	private $_api_key = '532DBCB494F40FC585EB0508D598B8B05F30C1DC';
...
//                print_r($result);
		...
		else
		{
			...
			if ($http_code != 200)
			{
				throw new PecomKabinetException(sprintf('HTTP error code: %d ' . $data, $http_code));
			}
