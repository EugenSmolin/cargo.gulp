...
@$cargoFromCountry = $_POST['cFC'];
@$cargoToCountry = $_POST['cTC'];
@$cargoFromState = $_POST['cFS'];
@$cargoToState = $_POST['cTS'];
    ...
    &&	isset($_POST['cH']))
{
    ...
    $width = floatval($_POST['cWd']);
    $length = floatval($_POST['cL']);
    $height = floatval($_POST['cH']);
}

// client language
$client_lang = isset($_POST["lang"]) ? $_POST["lang"] : "";

// client currency
$client_curr = isset($_POST["currency"]) ? $_POST["currency"] : "";
