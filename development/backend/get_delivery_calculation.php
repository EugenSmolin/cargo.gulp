...
@$cargoFromStreet = $oPOSTData->cargoFromStreet;
@$cargoToStreet  = $oPOSTData->cargoToStreet;
@$cargoFromStreetCode = $oPOSTData->cargoFromStreetCode;
@$cargoToStreetCode  = $oPOSTData->cargoToStreetCode;
$isDerivalByCourier = intval($oPOSTData->isDerivalByCourier);
$isArrivalByCourier = intval($oPOSTData->isArrivalByCourier);
...
// generate hash
    $searchHash = $hcache->GenerateHash($transportNum,
        $cityFrom,
        $cityTo,
        $cargoFromCountry,
        $cargoToCountry,
...
if(!IS_PRODUCTION)
{
    include  "modules/CALC_dellin.php";
}
else {
